...
function AdvcateReg() {
  ...
  const validateField3 = (fieldName, value) => {
    ...
    if (fieldName == 'cpassword' && !(data.cpassword == data.password)) {
  ...
  const handleSubmit =async (event) => {
    ...
    errors.bcNo = validateField('Bar Council Number', data.bcNo);
    errors.idProof = validateField('ID Proof', data.idProof);
    errors.profilePic = validateField('Profile Picture', data.profilePic);
    ...
    errors.cpassword = validateField3('cpassword', data.cpassword);
    ...
    if (formIsValid) {
      ...
      try {
        ...
        const result = await registerWithFile(data, 'registerAdvocate');
  ...
  return (
    <>
      <div className=''>
        <div>
          <h2 className="advocateRegistrationtitle">Attorney Registration Form</h2>

          <div className='row container-fluid'>

            <div className='col-6 advocateRegistrationmaindiv '>


              <img src={img1} ></img>
            </div>
            <div className='col-6  container-fluid mt-3'>
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="col-6">
                    <div className="custom-file-input-wrapper">
                      <label htmlFor="profilePic" className="custom-file-label">
                        {data.profilePic ? data.profilePic.name : "Upload Profile Picture"}
                      </label>
                      <input
                        type="file"
                ...
                <div className="row mt-5">
                  ...
                  <div className='advocateRegistrationdivlast mt-3 mb-5'>Already have an account?
                    <Link to='/advocate-login' className='advocateRegistrationdivlink mb-5'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login Now</Link></div>
                </div>
